...
var juegoDulces = {
  animacionTitulo: function(){
    console.log("funcion aniumacion itulo");
  ...
  cargarImagenes: function(){
    console.log("funcion cargar imagenes");
    var num = 1;
    var numImg = 1;
  ...
  iniciarJuego: function(){
    console.log("funcion iniciar juego ");
  ...
  inicioTiempo: function(){
    console.log("funcion inicio tiemop");
    $('#timer').timer({
  ...
  terminarJuego: function(){
    console.log("funcion terminar juego");
  ...
  reiniciarJuego: function(){
    console.log("funcion reiniciar juego ");
  ...
  obtenerColumnas: function(){
    console.log("funcion obtener columnas");
    var i = 0;
  ...
  obtenerFilas: function(){
    console.log("funcion obtener filas");
    var i = 0;
    this[i++] = $("[id*=img-1]");
    this[i++] = $("[id*=img-2]");
    this[i++] = $("[id*=img-3]");
  ...
  agregarDiv: function(){
    console.log("funcion agregar div");
    bloqueo = 1;
    setTimeout(function(){
  ...
  animacionAcertar: function(){
    console.log("funcion animacion acertar");
    var array
    var claseCol
    var cajaDulce
  ...
  scanRepetidosCol: function(){
    console.log("funcion scanear repetidos col ");
    var imagen = new this.imagenes;
